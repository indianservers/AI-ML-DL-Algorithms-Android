...
object MlLabContent {
    val algorithms = listOf(
        ...
        Algorithm("arima", "ARIMA", AlgorithmFamily.TimeSeries, "Autoregressive forecasting", AlgorithmStatus.LessonReady, 0xFF4AA3FF),
        Algorithm("sarima", "SARIMA", AlgorithmFamily.TimeSeries, "Seasonal ARIMA", AlgorithmStatus.LessonReady, 0xFF7C5CFF),
        ...
        Algorithm("multi-armed-bandits", "Multi-Armed Bandits", AlgorithmFamily.Reinforcement, "Explore versus exploit", AlgorithmStatus.Interactive, 0xFFFFB02E),
        ...
        Algorithm("q-learning", "Q-Learning", AlgorithmFamily.Reinforcement, "Value learning from rewards", AlgorithmStatus.Interactive, 0xFF7C5CFF),
